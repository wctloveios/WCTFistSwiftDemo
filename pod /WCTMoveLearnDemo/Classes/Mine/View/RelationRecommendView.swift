...
//    var userCards = [UserCard]()
    ...
    override func awakeFromNib() {
        ...
        collectionView.wct_registerCell(cell: RelationRecommendCell.self)
...
extension RelationRecommendView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.wct_dequeueReusableCell(indexPath: indexPath) as RelationRecommendCell
