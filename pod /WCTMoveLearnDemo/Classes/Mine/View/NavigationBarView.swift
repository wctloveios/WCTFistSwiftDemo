...
//    }
    ...
    override func awakeFromNib() {
        ...
        concernButton.theme_backgroundColor = concernButton.isSelected ? "colors.userDetailFollowingConcernBtnBgColor" : "colors.globalRedColor"
        concernButton.borderColor = concernButton.isSelected ? .grayColor232() : .globalRedColor()
        concernButton.borderWidth = concernButton.isSelected ? 1 : 0
    }
